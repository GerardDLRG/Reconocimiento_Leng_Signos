...
from keras.layers import LSTM, Dense,  TimeDistributed, Conv2D, MaxPooling2D, Dropout, Flatten, Conv1D, MaxPooling1D
...
model.fit(X_train, Y_train, epochs=35, validation_data=(X_test, Y_test), callbacks=[tb_callback])
model.save('actionCon100.h5')
model.summary()
